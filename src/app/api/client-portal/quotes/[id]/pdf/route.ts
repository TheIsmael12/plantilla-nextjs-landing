 ...
 * exige `Authorization: Bearer` en `client/me/quotes/:id/pdf` y un `<a href>`
 * del navegador no puede añadir esa cabecera: el enlace apunta a esta ruta
 ...
 * @param {{params: Promise<{id: string}>}} context - Parámetros de ruta con el id del presupuesto
