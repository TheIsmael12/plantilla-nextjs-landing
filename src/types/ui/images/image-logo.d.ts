 ...
 * @property {number} [width] - Ancho en píxeles pasado a `next/image`; por defecto 100
 * @property {number} [height] - Alto en píxeles pasado a `next/image`; por defecto 60
 ...
 * @property {string} [className] - Clases CSS adicionales aplicadas a la imagen
 */
