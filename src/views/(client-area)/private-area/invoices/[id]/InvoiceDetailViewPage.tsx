 ...
 */
export default async function InvoiceDetailViewPage({ id, locale }: InvoiceDetailViewPageProps) {
  ...
  const backLink = (
    <Link href={resolveHref('/private-area/invoices')} className="client-area-page__back">
