 ...
 */
export default async function ServiceDetailViewPage({ id, locale }: ServiceDetailViewPageProps) {
  ...
  const backLink = (
    <Link href={resolveHref('/private-area/services')} className="client-area-page__back">
