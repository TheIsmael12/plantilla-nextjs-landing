...
import CommunityAccessOverview from '@/components/ui/client-area/community/CommunityAccessOverview';
import CommunityAnnouncementsBoard from '@/components/ui/client-area/community/CommunityAnnouncementsBoard';
import CommunityDashboard from '@/components/ui/client-area/community/CommunityDashboard';
 ...
 */
export default async function CommunityHomeViewPage({
  serviceId,
  locale,
  ...
  return (
    <>
      <header className="community-layout__header">
        <h1 className="community-layout__title">{community?.serviceName ?? t('title')}</h1>
        <p className="community-layout__description">
      ...
      <section className="community-home__section">
        <header className="community-home__section-head">
          <h2 className="community-home__section-title">
            <MegaphoneIcon aria-hidden="true" />
            {t('boardTitle')}
          </h2>
          <p className="community-home__section-hint">{t('boardHint')}</p>
        </header>
      ...
      <section className="community-home__section">
        <header className="community-home__section-head">
          <h2 className="community-home__section-title">{t('chartsTitle')}</h2>
          <p className="community-home__section-hint">
            {isTruncated ? t('chartsHintTruncated', { shown: items.length }) : t('chartsHint')}
          </p>
        </header>
      ...
      */}
      {community?.keyringEnabled && (
        <section className="community-home__section">
          <header className="community-home__section-head">
            <h2 className="community-home__section-title">{t('accessTitle')}</h2>
            <p className="community-home__section-hint">{t('accessHint')}</p>
          </header>
