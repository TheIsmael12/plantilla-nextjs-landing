...
import UnitsTable from '@/views/(client-area)/private-area/communities/details/units/components/UnitsTable';
 ...
 */
export default function CommunitiesUnitsPanel({ serviceId, units }: UnitsManagerProps) {
