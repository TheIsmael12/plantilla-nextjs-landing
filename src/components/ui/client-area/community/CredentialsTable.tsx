 ...
 * @param {CredentialsTableProps} props - Página actual de credenciales, locale y handlers de enrolado/revocación (delegados a `CredentialsManager`, dueño de los modales)
