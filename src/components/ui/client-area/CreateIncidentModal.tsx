...
/**
 * Botón y asistente para abrir una incidencia desde el portal.
 *
 ...
 * @returns {JSX.Element} El botón con su asistente de creación
 */
export default function CreateIncidentModal({ services }: CreateIncidentModalProps) {
  ...
  return (
    <>
      <Button variant="primary" title="createIncident" onClick={() => setIsOpen(true)}>
      ...
      {isOpen && (
        <ModalComponent
          ...
          onClose={close}
          /*
           * El pie lo pone el asistente, no el modal: «Atrás» y «Siguiente» cambian de sitio y de texto
           * según el paso, y en el último el botón deja de ser «Siguiente» y pasa a ser «Abrir la
           * incidencia». Un pie fijo de confirmar/cancelar no puede decir eso.
           */
        >
          <div className="incident-wizard">
            ...
            <div className="incident-wizard__actions">
              {stepIndex > 0 ? (
                ...
                <Button variant="outline" title="cancel" onClick={close} />
              )}
